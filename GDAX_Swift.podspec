#
#  Be sure to run `pod spec lint GDAXSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Alexandre" => "alexandr.barbier@gmail.com" }
  # Or just: s.author    = "Alexandre"
  # s.authors            = { "Alexandre" => "alexandr.barbier@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alexandre"
